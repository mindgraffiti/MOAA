...
class Zoo_visitor_mcp
{
	...
	function sync()
	{
		...
		// ===================================
		// = Check if Visitor channel exists =
		// ===================================
/*
...
*/
	...
	function install_visitor(){
		...
		if ($query->num_rows() == 0){
			...
			$data['password']	= $this->EE->functions->hash('zoo_visitor_login');
		...
		// = Create templates =
		// ====================
		$templates = array('index','menu','register','profile','login','change_password','change_login','forgot_password');
