...
'email_confirmation'	=> 'Require email confirmation<br/><span class="subtext">do not forget to add confirm_email input in the form</span>',
'password_confirmation'	=> 'Require password confirmation when registering<br/><span class="subtext">do not forget to add confirm_password input in the form when set to yes</span>',
...
// = Sync =
// ========
'sync_title'	=> 'Synchronize members',
...
'sync_submitted'	=> '<fieldset style="text-align:center;"><legend><b></b></legend><h3>Members have been synced.</h3></fieldset><br/>',
);
}