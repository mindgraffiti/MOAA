...
// Added the icons class for CSS positioning and any other added polish needed.
    $icon_img = ' <img src="http://missouriangus.ehclients.com/images/icons/'.$icon.'" alt="'.$alt_tag.'" class="icons">';
// Changed the icon image to show up on the left hand side rather than the right hand side.
    if($icon) {
      $return_data = anchor($file_url, $icon_img.$link_title, 'title="'.$link_title.'"');
    } else {
