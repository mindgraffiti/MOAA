...
$config['install_lock'] = "";
$config['license_number'] = "6382-4291-7261-1589";
$config['debug'] = '1';
$config['cp_url'] = "http://missouriangus.ehclients.com/syshfe/index.php";
$config['doc_url'] = "http://expressionengine.com/user_guide/";
$config['is_system_on'] = "y";
$config['allow_extensions'] = 'y';
$config['site_label'] = 'Missouri Angus Association';
...
/ ------------------------------------------------------------------------
/
/ Path variables for the third party image resizer.
/
*/
$config['ed_server_path'] = 'public_html/'; // Server path to your site's web root
$config['ed_cache_path'] = 'public_html/images/resizer_cache/'; // Server path to where your resized images should be stored
